...
*/            
        ...
        public PersonResponse AddPerson(PersonAddRequest? personAddRequest)
        {
            ...
            //convert from request to person
        ...
        public PersonResponse? GetPersonByPersonId(Guid? PersonId) 
        {
            ...
            Person? person_Response_From_Search = _db.Persons.FirstOrDefault(temp => temp.PersonId == PersonId);
            if(person_Response_From_Search==null)
            {
                return null;
            }
            return ConvertPersonToPersonResponse (person_Response_From_Search);
        }
